...
import { bookingCartTotal, readBookingCart } from '@/lib/booking-cart';
import '../booking.css';
...
export default function BookingCheckoutPage() {
  ...
  return <div className="booking-page"><div className="booking-shell checkout-shell">
    ...
    {state.loading ? <div className="booking-empty"><h2>플랫폼 상태를 확인하고 있습니다.</h2><p>예약 소유권과 결제 가능 금액을 조회합니다.</p></div> : <div className="checkout-grid">
