...
const services = [
  { key: 'cruise', name: '크루즈', copy: '홈페이지 상품에서 객실과 일정을 고르고 장바구니에 담습니다.', href: '/cruises', legacyPath: 'cruise', ready: true },
  { key: 'cruise_vehicle', name: '크루즈 차량', copy: '승선 전후 이동 차량을 크루즈 일정과 함께 준비합니다.', href: '/booking/service/cruise_vehicle', legacyPath: 'cruise/vehicle', ready: true },
  { key: 'airport', name: '공항 이동', copy: '공항, 항공편, 경유지와 인원을 기준으로 차량을 예약합니다.', href: '/booking/service/airport', legacyPath: 'airport', ready: true },
  { key: 'hotel', name: '호텔', copy: '숙박일, 객실 수, 인원과 조식 조건을 접수합니다.', href: '/hotels', legacyPath: 'hotel', ready: true },
  { key: 'rentcar', name: '렌터카', copy: '픽업·도착 위치와 탑승 인원을 기준으로 차량을 선택합니다.', href: '/booking/service/rentcar', legacyPath: 'rentcar', ready: true },
  { key: 'tour', name: '투어', copy: '이용일, 픽업 위치와 참가 인원을 기준으로 투어를 예약합니다.', href: '/booking/service/tour', legacyPath: 'tour', ready: true },
  { key: 'package', name: '패키지', copy: '여러 서비스를 하나의 일정과 견적으로 묶어 준비합니다.', href: '/booking/service/package', legacyPath: 'package', ready: true },
  { key: 'ticket', name: '티켓', copy: '공연과 입장권의 이용일 및 인원을 선택합니다.', href: '/booking/service/ticket', legacyPath: 'ticket', ready: true },
];
        ...
        <div className="service-grid">
          {services.map((service, index) => <article className="service-card" key={service.key}>
            ...
            <div className="service-actions">
              ...
              <a href={`${PLATFORM}/mypage/direct-booking/${service.legacyPath}`} target="_blank" rel="noreferrer" className="service-link legacy">기존 플랫폼 ↗</a>
            </div>
          </article>)}
        </div>
