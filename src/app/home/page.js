      ...
      <section className={styles.hero}>
        <div className={styles.heroCopy}>
          ...
          <div className={styles.actions}>
            <a href="https://customer.stayhalong.com/signup" className={styles.yellowButton} target="_blank" rel="noreferrer">신규 예약 <span>↗</span></a>
            <a href="https://customer.stayhalong.com/" className={styles.yellowButton} target="_blank" rel="noreferrer">예약 추가/확인 <span>↗</span></a>
