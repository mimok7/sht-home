...
export default function AdminCruiseManager({ importOnly = false }) {
  ...
  function isServiceSelected(service) {
    ...
    return ['profile', 'tags', 'recommendation-priorities', 'cabins', 'rates'].includes(activePanel);
  }
  ...
  const requiresCruiseSelection = !importOnly && !['catalog', 'members', 'recommendation-priorities', 'change-requests', 'change-request-status', 'change-request-completed'].includes(activePanel);
